  ...
  return (
    <>
      ...
      <main className="py-[180px] max-b1080:py-[120px] max-b580:py-[80px]">
          ...
          <div className="wrap-in2 relative">
            ...
            <ul className="grid grid-cols-5 gap-5 max-b1080:grid-cols-3 max-b580:grid-cols-2">
              {OVERVIEW.coreValues.map((value, index) => (
                <li key={value.title} className="flex aspect-square flex-col items-center justify-center rounded-full border border-white/90 bg-[linear-gradient(145deg,#f7fcff_0%,#dff2fa_100%)] p-7 text-center shadow-[0_18px_45px_rgba(55,105,135,0.13),inset_0_0_0_1px_rgba(112,190,224,0.2)] max-b1080:last:col-start-2 max-b580:last:col-auto">
        ...
        <section className="mt-[150px] bg-[#211c20] bg-cover bg-center py-[110px] text-white max-b580:mt-[90px] max-b580:py-[75px]" style={{ backgroundImage: OVERVIEW.companyBgFallback }}>
