...
export default function InlineAdminToolbar({
  ...
  return (
    <aside
      aria-label="관리자 도구"
      className="fixed bottom-[30px] left-1/2 z-[998] flex w-[min(900px,calc(100vw-48px))] -translate-x-1/2 flex-wrap items-center justify-between gap-4 rounded-2xl border border-sky-200 bg-sky-50/95 px-5 py-4 shadow-[0_10px_32px_rgba(15,78,132,0.18)] backdrop-blur-md max-b1080:bottom-[76px] max-b580:bottom-[68px] max-b580:w-[calc(100vw-24px)] max-b580:items-stretch max-b580:gap-2 max-b580:rounded-xl max-b580:px-3 max-b580:py-2.5"
    >
